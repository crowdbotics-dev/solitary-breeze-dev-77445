...
## Project Structure
    ...
    ├── solitary_breeze_dev_77445  # Django project configurations
...
1. Clone this repo and `cd solitary_breeze_dev_77445`
...
2. Clone this repo and `cd solitary_breeze_dev_77445`
